...
<div class="tabs shadow-sm mb-3 p-3">
    <div class="row">
        <div class="col-6">
            <h5><i class="bi bi-tags-fill me-2"></i>Tài khoản</h5>
    ...
    <div class="row">
        <div class="col-3 card">
            <ol class="list-group mt-3">
                <a href="/users" class="text-decoration-none text-dark">
                    <li class="list-group-item d-flex justify-content-between align-items-start <?= !isset($_GET['hide']) ?>">
                        <div class="ms-2 me-auto">
                            <div class="fw-bold">Tất cả tài khoản</div>
                            <small>Last updated 3 mins ago</small>
                        </div>
                ...
                <a href="/users?hide=2" class="text-decoration-none text-dark">
                    <li class="list-group-item d-flex justify-content-between align-items-start <?= (isset($_GET['hide']) && $_GET['hide'] == 2) ?>">
                        <div class="ms-2 me-auto">
                            <div class="fw-bold">Tài khoản bị đóng</div>
                            <small>Last updated 3 mins ago</small>
                        </div>
        ...
        <div class="mx-4 col-8 card">
            <div class="card-body">
                <strong class="">Danh sách tài khoản
                </strong>
                <div class="row mt-3">
                    <div class="col-6">
                        <form class="d-flex" role="search" action="/search_user" method="POST">
                    ...
                    <div class="col-6 text-end">
                        <a href="/user_create"><button type="button" class="btn btn-success mb-2">Thêm Tài Khoản !</button>
                    </div></a>
                </div>
