            ...
            <div class="col-8">
                <div class="card p-3 shadow-sm">
                    <div class="mb-3">
                        ...
                        <label for="exampleInputEmail1" class="form-label">Tên thẻ</label>
                        <input type="text" class="form-control" id="" aria-describedby="" value="<?= $tags['name'] ?>">
                        <div id="emailHelp" class="form-text">Tên không được trùng với thẻ đã được tạo.</div>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Slug</label>
                        <input type="tex" class="form-control" id="exampleInputPassword1">
