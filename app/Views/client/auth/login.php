      ...
      <div class="card-body p-4 p-lg-5 text-black">
        <form action="login_user" method="POST">
          ...
          <div data-mdb-input-init class="form-outline mb-4">
            ...
            <input type="email" id="form2Example17" class="form-control form-control-lg" name="email" style="font-size: 1rem;" placeholder="Nhập email của bạn" />
          </div>

          <div data-mdb-input-init class="form-outline mb-4">
            <label class="form-label" for="form2Example27">Mật Khẩu</label>
            <input type="password" id="form2Example27" class="form-control form-control-lg" name="password" style="font-size: 1rem;" placeholder="Nhập mật khẩu của bạn" />
          </div>
