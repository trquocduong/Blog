    ...
    <div class="col-lg-7 d-flex align-items-center p-3">
      <div class="card-body p-4 p-lg-5 text-black">
        ...
        <form action="/register_user" method="POST">
          ...
          <h5 class="fw-normal pb-3" style="letter-spacing: 1px;"><strong>Đăng ký</strong></h5>
          <p style="color:red"><?= $error ?? '' ?></p>
          <div data-mdb-input-init class="form-outline mb-3">
            <label class="form-label" for="form2Example17">Email của bạn</label>
            <input type="email" id="form2Example17" class="form-control form-control-lg" name="email" style="font-size: 1rem;" placeholder="Nhập email hoặc tên của bạn" />
          </div>
          <div data-mdb-input-init class="form-outline mb-3">
          ...
          <div data-mdb-input-init class="form-outline mb-3">
            ...
            <input type="password" id="form2Example27" class="form-control form-control-lg" style="font-size: 1rem;" name="repassword" placeholder="Nhập lại mật khẩu ." />

          </div>

          <div class="pt-1 mb-4 ">
            <button data-mdb-button-init data-mdb-ripple-init class="btn btn-dark btn-lg btn-block " type="submit" style="
