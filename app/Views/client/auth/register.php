          ...
          <div class="col-lg-7 d-flex align-items-center p-3">
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form>
                  ...
                  <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;"><strong>Đăng ký</strong></h5>
                  <div data-mdb-input-init class="form-outline mb-4">
                     <label class="form-label" for="form2Example17">Email hoặc Tên</label>
                    <input type="email" id="form2Example17" class="form-control form-control-lg" style="font-size: 1rem;" placeholder="Nhập email hoặc tên của bạn" />
                  </div>
                  <div data-mdb-input-init class="form-outline mb-4">
                     <label class="form-label" for="form2Example47">Số Điện Thoại</label>
                    <input type="text" id="form2Example47" class="form-control form-control-lg" style="font-size: 1rem;" placeholder="Nhập số điện thoại của bạn" />
                  </div>
                  <div data-mdb-input-init class="form-outline mb-4">
                     <label class="form-label" for="form2Example37">Mật khẩu</label>
                    <input type="password" id="form2Example37" class="form-control form-control-lg" style="font-size: 1rem;" placeholder="Hãy tạo mật khẩu riêng của bạn" />
                  </div>

                  <div data-mdb-input-init class="form-outline mb-4">
                    <label class="form-label" for="form2Example27">Nhập Lại Mật Khẩu</label>
                    <input type="password" id="form2Example27" class="form-control form-control-lg" style="font-size: 1rem;" placeholder="Nhập lại mật khẩu ."/>
                    
                  </div>

                  <div class="pt-1 mb-4 ">
                    <button data-mdb-button-init data-mdb-ripple-init class="btn btn-dark btn-lg btn-block " type="button" style="
                   background-color: var(--main-color);">Đăng ký</button>
                  </div>
               ...
               <button  type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-floating mx-1">
                ...
                <br>
                  ...
                  <p class="mb-5 pb-lg-2" style="color: #393f81;">Bạn đã có tài khoản ? <a href="/login"
